...
const ACTIVITY = [
  {
    text: "Dr. Smith added new prescription for Marcus Lee",
    time: "2m ago",
    icon: Pill,
    color: "blue",
  },
  {
    text: "Sarah Johnson appointment confirmed for 9:00 AM",
    time: "15m ago",
    icon: CheckCircle,
    color: "green",
  },
  {
    text: "New patient Emma Wilson registered",
    time: "1h ago",
    icon: UserPlus,
    color: "teal",
  },
  {
    text: "Lab results uploaded for James Carter",
    time: "2h ago",
    icon: Upload,
    color: "indigo",
  },
  {
    text: "Subscription renewed: Pro Plan",
    time: "3h ago",
    icon: Star,
    color: "amber",
  },
...
const Card = ({ children, className = "", hover = true, glass = false }) => (
  <motion.div
    whileHover={
      hover ? { y: -2, boxShadow: "0 20px 40px -10px rgba(0,0,0,0.12)" } : {}
    }
    transition={{ duration: 0.2 }}
    className={cls(
      "rounded-2xl border p-6",
      glass
        ? "bg-white/70 backdrop-blur-sm border-white/80 shadow-lg"
...
const Btn = ({
  ...
  const variants = {
    primary:
      "bg-gradient-to-r from-blue-500 to-teal-500 text-white hover:from-blue-600 hover:to-teal-600 shadow-md shadow-blue-200",
  ...
  return (
    <motion.button
      ...
      disabled={disabled}
      className={cls(
        "flex items-center gap-2 rounded-xl font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed",
        variants[variant],
        sizes[size],
        className,
      )}
...
const Sidebar = ({ collapsed, onToggle, role, activePage, onNav, dark }) => {
  ...
  return (
    <motion.aside
      ...
      className={cls(
        "h-screen flex flex-col border-r sticky top-0 flex-shrink-0 overflow-hidden z-20",
    ...
    >
      ...
      <button
        onClick={onToggle}
        className={cls(
          "m-3 flex items-center justify-center w-8 h-8 rounded-lg border transition-all",
          dark
...
const Topbar = ({ role, onLogout, dark, onToggleTheme }) => {
  const roleNames = {
    admin: "Dr. Admin Kumar",
    doctor: "Dr. Sarah Mitchell",
    receptionist: "Alex Rivera",
    patient: "James Carter",
  };
  return (
    <header
      className={cls(
        "h-16 px-6 flex items-center justify-between border-b sticky top-0 z-10",
        dark
                ...
                <div className="grid grid-cols-4 gap-2">
                  {["admin", "doctor", "receptionist", "patient"].map((r) => (
                    <button
                      ...
                      className={cls(
                        "py-2 px-1 rounded-xl border text-xs font-medium capitalize transition-all",
                        form.role === r
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-50 via-white to-blue-50 p-4 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-sm text-slate-500 mb-6">
          Join our clinic management platform
        </p>
    ...
    <Card>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <Btn variant="outline" size="sm" icon={Filter}>
            Filter
          </Btn>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-slate-100">
              {["Patient", "Age", "Condition", "Next Visit", "Status", ""].map(
                (h) => (
                  <th
                    key={h}
                    className="text-left py-2 px-3 text-xs font-medium text-slate-500 whitespace-nowrap"
                  >
                    {h}
                  </th>
                ),
            ...
            >
              <div
                className={cls(
                  ...
                  colorMap[a.color] || colorMap.blue,
                )}
              >
                <Icon size={14} />
              </div>
        ...
        <div className="space-y-4">
          <Card className="bg-gradient-to-br from-blue-600 to-teal-600 text-white border-0 shadow-xl shadow-blue-200">
            ...
            <p className="text-sm text-white/80 mb-4">
              AI-powered diagnostic support and clinical insights.
            </p>
            <button
              ...
              {aiOpen && (
                ...
                >
                  <p className="text-xs text-white/90">
                    "Patient shows elevated glucose with fatigue – consider
                    HbA1c test and dietary consult."
                  </p>
            ...
            <div className="grid grid-cols-7 gap-1 text-center text-xs">
              ...
              {Array.from({ length: 28 }, (_, i) => i + 1).map((d) => (
                <div
                  key={d}
                  className={cls(
                    "py-1.5 rounded-lg cursor-pointer transition-all text-slate-600 hover:bg-blue-50",
                    d === 1
          ...
          <div className="space-y-2">
            {PATIENTS.map((p, i) => (
              ...
              >
                ...
                <StatusBadge status={p.status} />
                <button className="p-1.5 rounded-lg hover:bg-white text-slate-400 hover:text-blue-500">
      ...
      <Card className="h-fit">
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <input
              type="datetime-local"
              className="w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400"
            />
          </div>
          <div>
            <label className="text-sm font-medium text-slate-700 block mb-1.5">
...
const PatientDashboard = ({ dark }) => {
  ...
  const checkSymptoms = async () => {
    ...
    setAiResult({
      risk: "medium",
      text: "Based on your symptoms, you may have a mild respiratory infection. Recommended actions: rest, hydration, and consider a GP visit if symptoms persist beyond 3 days.",
    });
  };
  ...
  const timeline = [
    {
      ...
      doctor: "Dr. Mitchell",
      note: "Blood pressure slightly elevated. Advised low-sodium diet.",
      status: "completed",
    },
    {
      date: "Mar 3, 2025",
      ...
      doctor: "Dr. Mitchell",
      note: "BP normalized. Continue current medication.",
      status: "completed",
    },
    {
      date: "May 20, 2025",
      ...
      doctor: "Dr. Patel",
      note: "HbA1c within normal range. Good progress.",
      status: "completed",
    },
    {
      date: "Jul 1, 2025",
      title: "Annual Physical (upcoming)",
      doctor: "Dr. Mitchell",
      note: "Scheduled",
      status: "confirmed",
    },
    ...
    >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        ...
        <Card glass className="flex flex-col items-center text-center">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-400 to-teal-500 flex items-center justify-center text-2xl font-bold text-white mb-3 shadow-lg shadow-blue-200">
            JC
          </div>
        ...
        <div className="space-y-3">
          <Card>
            ...
            {PATIENTS.slice(0, 2).map((p, i) => (
              <div
                key={i}
                className="flex items-center gap-3 p-2 rounded-xl hover:bg-blue-50 transition-colors mb-2"
              >
          ...
          <AnimatePresence>
            {aiLoading && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="mt-3 p-3 bg-blue-50 rounded-xl flex items-center gap-2"
              >
            ...
            {timeline.map((item, i) => (
              ...
              >
                ...
                <div className="flex-1 pb-2">
                  ...
                  <p className="text-sm text-slate-600 mt-1 bg-slate-50 rounded-xl px-3 py-2">
                    {item.note}
                  </p>
                </div>
              </motion.div>
...
const AIPage = ({ dark }) => {
  ...
  const [messages, setMessages] = useState([
    {
      role: "ai",
      text: "Hello! I'm MediMind AI. I can help with symptom analysis, drug interactions, and clinical decision support. How can I assist you today?",
    },
  ]);
  ...
  const send = async () => {
    ...
    setMessages((m) => [
      ...
      {
        role: "ai",
        text: "Based on the information provided, I recommend a comprehensive evaluation including CBC, metabolic panel, and HbA1c. The symptoms suggest a possible metabolic disorder. Risk level: Medium. Please consult with the attending physician for a definitive diagnosis.",
      },
    ]);
  };
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">
            Powered by MediMind AI · Always verify with a physician
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          <div
            key={r.level}
            className={`p-3 rounded-xl border bg-${r.color}-50 border-${r.color}-100`}
          >
            <div className="flex items-center gap-2 mb-1">
              <div className={cls("w-2.5 h-2.5 rounded-full", r.dot)} />
              <span className={`text-sm font-semibold text-${r.color}-700`}>
                {r.level}
              </span>
            </div>
      ...
      <div className="flex items-start gap-2 p-3 bg-amber-50 border border-amber-200 rounded-xl">
        ...
        <p className="text-xs text-amber-700">
          AI suggestions are for clinical decision support only. Always verify
          with qualified medical professionals before making treatment
          decisions.
        </p>
      </div>
    </motion.div>
    ...
    <Card>
      <div className="space-y-5">
        ...
        <div className="flex gap-3">
          <Btn variant="primary" size="lg" icon={Plus}>
            Register Patient
          </Btn>
  ...
  patients: (p) => (
    <div className="space-y-4">
      <h1
        className={cls(
          "text-2xl font-bold",
          p.dark ? "text-white" : "text-slate-800",
        )}
      >
        Patient Management
      </h1>
        ...
        {screen === "app" && (
          ...
          >
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
              ...
              <div
                className={cls(
                  "px-4 py-2 flex items-center gap-2 border-b text-xs flex-wrap",
                  dark
                    ? "bg-slate-900 border-slate-700"
              ...
              >
                ...
                {["admin", "doctor", "receptionist", "patient"].map((r) => (
                  <button
                    ...
                    onClick={() => login(r)}
                    className={cls(
                      "px-3 py-1 rounded-lg capitalize font-medium transition-all",
                      role === r
